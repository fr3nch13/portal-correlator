...
?>
<div class="top">
	<h1><?php echo __('Edit %s', __('Temp Category')); ?></h1>
</div>
<div class="center">
	<div class="form" id="object-form-<?php echo $form_id; ?>">
		<?php echo $this->Form->create('TempCategory');?>
			<fieldset>
				<legend><?php echo __('Edit %s', __('Temp Category')); ?></legend>
				<?php
					...
					echo $this->Form->input('scan_desc', array(
						'type' => 'checkbox',
						'label' => __('Check to rescan Description for Vectors'),
					));
					echo $this->Form->input('TempCategoriesDetail.id', array(
						'type' => 'hidden'
					));
		...
		<?php echo $this->Form->end(__('Save %s', __('Temp Category'))); ?>
	</div>
</div>
