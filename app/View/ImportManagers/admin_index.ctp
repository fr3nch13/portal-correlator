<?php 
// File: app/View/ImportManagers/admin_index.ctp

$page_options = array(
	$this->Html->link(__('Add Import Manager'), array('action' => 'add')),
);
...
//		$org_group,
		...
		array(
			...
			$this->Html->link(__('Edit'), array('action' => 'edit', $importManager['ImportManager']['id'])).
			$this->Form->postLink(__('Delete'),array('action' => 'delete', $importManager['ImportManager']['id']),array('confirm' => 'Are you sure?')), 
			array('class' => 'actions'),
		),
	);
}
