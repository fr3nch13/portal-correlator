<?php ?>
<!-- File: app/View/TempUploadsVectors/admin_assign_vector_type.ctp -->
<div class="top">
	<h1><?php echo __('Assign all Vectors to one Group'); ?></h1>
</div>
<div class="center">
	<div class="posts form">
	<?php echo $this->Form->create('TempUploadsVector', array('url' => array('action' => 'assign_vector_type', $temp_upload_id)));?>
	    <fieldset>
