...
//	$th['Import.filename'] = array('content' => __('File Name'), 'options' => array('sort' => 'Import.filename'));
	$th['ImportManager.name'] = array('content' => __('Manager'), 'options' => array('sort' => 'ImportManager.name'));
...
foreach ($imports as $i => $import)
{
	...
	$td[$i]['ImportManager.name'] = $this->Html->link($import['ImportManager']['name'], array('controller' => 'import_managers', 'action' => 'view', $import['ImportManager']['id']));
...
echo $this->element('Utilities.page_index', array(
	'page_title' => __('Tagged %s', __('Imports')),
