<?php 
// File: app/View/VtNtRecords/protocol.ctp
...
{
	$actions = array();
	$VectorLookup_link = $this->Html->link($vt_nt_record['VectorLookup']['vector'], array('controller' => 'vectors', 'action' => 'view', $vt_nt_record['VectorLookup']['id']));
	...
	if(in_array($vt_nt_record['VectorLookup']['type'], $vtTypeList))
	{
		$actions[] = $this->Html->link(__('VT View Vector Lookup'), array('controller' => 'vectors', 'action' => 'vtview', $vt_nt_record['VectorLookup']['id']));
		$VectorLookup_link = $this->Html->link($vt_nt_record['VectorLookup']['vector'], array('controller' => 'vectors', 'action' => 'vtview', $vt_nt_record['VectorLookup']['id']));
	}
	$actions[] = $this->Html->link(__('View Lookup'), array('controller' => 'vectors', 'action' => 'view', $vt_nt_record['VectorLookup']['id']));
...
echo $this->element('Utilities.page_index', array(
	...
	'page_title' => __('%s %s by %s: %s', __('VirusTotal'), __('Network Records'), __('Protocol'), $this->Wrap->niceWord($protocol)),
