...
{
	$org_group = $this->Html->link($upload['OrgGroup']['name'], array('controller' => 'org_groups', 'action' => 'view', $upload['OrgGroup']['id'], 'admin' => true));
}

$details_left = array();
$details_left[] = array('name' => __('Owner'), 'value' => $this->Html->link($upload['User']['name'], array('controller' => 'users', 'action' => 'view', $upload['User']['id'])));
$details_left[] = array('name' => __('Org Group'), 'value' => $org_group);
...
$details_right = array();
$details_right[] = array('name' => __('MD5'), 'value' => $this->Html->link($upload['Upload']['md5'], array('controller' => 'uploads', 'action' => 'index', 'q' => $upload['Upload']['md5'])) );
