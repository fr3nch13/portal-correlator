<?php 
// File: app/View/Uploads/admin_compare.ctp

$details_left = array();
$org_group_1 = $this->Html->link(__('None'), array('controller' => 'org_groups', 'action' => 'view', '0'));
if(isset($upload_1['OrgGroup']['id']) and $upload_1['OrgGroup']['id'])
{
	$org_group_1 = $this->Html->link($upload_1['OrgGroup']['name'], array('controller' => 'org_groups', 'action' => 'view', $upload_1['OrgGroup']['id']));
}
...
if(isset($upload_2['OrgGroup']['id']) and $upload_2['OrgGroup']['id'])
{
	$org_group_2 = $this->Html->link($upload_2['OrgGroup']['name'], array('controller' => 'org_groups', 'action' => 'view', $upload_2['OrgGroup']['id']));
}
