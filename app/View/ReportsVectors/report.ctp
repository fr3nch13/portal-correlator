<?php 
// File: app/View/ReportsVectors/report.ctp
...
// content
$th = array(
	'ReportsVector.id' => array('content' => __('Xref ID'), 'options' => array('sort' => 'ReportsVector.id')),
...
foreach ($reports_vectors as $i => $reports_vector)
{
	...
	$td[$i] = array(
		$reports_vector['ReportsVector']['id'],
		$reports_vector['Vector']['id'],
