...
?>
<div class="top">
	<h1><?php echo __('Edit %s', __('Report')); ?></h1>
</div>
<div class="center">
	<div class="form" id="object-form-<?php echo $form_id; ?>">
		<?php echo $this->Form->create('Report');?>
		    <fieldset>
		        <legend><?php echo __('Edit %s', __('Report')); ?></legend>
		    	<?php
					...
					echo $this->AutoComplete->input('Report.mysource', array(
						'div' => array('class' => 'forth'),
					...
					echo $this->Form->input('ReportsDetail.desc_private', array(
		...
		<?php echo $this->Form->end(__('Update %s', __('Report'))); ?>
	</div>
</div>
