...
if($report_1['ReportType']['org_group_id'] == AuthComponent::user('org_group_id'))
{
	$details_left[] = array('name' => __('Report Group'), 'value' => $this->Html->link($report_1['ReportType']['name'], array('admin' => false, 'controller' => 'report_types', 'action' => 'view', $report_1['ReportType']['id'])). '&nbsp;');
}
else
{
	$details_left[] = array('name' => __('Report Group'), 'value' => $report_1['ReportType']['name']. '&nbsp;');
}
...
if($report_2['ReportType']['org_group_id'] == AuthComponent::user('org_group_id'))
{
	$details_right[] = array('name' => __('Report Group'), 'value' => $this->Html->link($report_2['ReportType']['name'], array('admin' => false, 'controller' => 'category_types', 'action' => 'view', $report_2['ReportType']['id'])). '&nbsp;');
}
else
{
	$details_right[] = array('name' => __('Report Group'), 'value' => $report_2['ReportType']['name']. '&nbsp;');
}
