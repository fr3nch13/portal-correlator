<?php 
// File: app/View/TempUploads/category.ctp
...
*/
	...
	if($category['Category']['user_id'] == AuthComponent::user('id'))
	{
		...
		$actions .= $this->Html->link(__('Delete'),array('action' => 'delete', $temp_upload['TempUpload']['id'], 'hash' => 'ui-tabs-10'),array('confirm' => 'Are you sure?'));
		$actions .= $this->Html->link(__('Reviewed'), array('action' => 'reviewed', $temp_upload['TempUpload']['id'], $category_id), array('confirm' => __('Are you sure?'), 'class' => 'button_red'));
		$td[$i]['actions'] = array(
			$actions,
			array('class' => 'actions'),
		);
...
echo $this->element('Utilities.page_index', array(
	'page_title' => __('Category\'s Temp Files'),
