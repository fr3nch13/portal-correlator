<?php 
// File: app/View/TempUploads/temp_category.ctp

$page_options = array();
$page_options[] = $this->Html->link(__('Add File'), array('action' => 'add', 'temp_category_id' => $temp_category_id));
...
foreach ($temp_uploads as $i => $temp_upload)
{
	...
	$td[$i]['TempUpload.filename'] = $td[$i]['TempUpload.filename'] = $this->Html->link($temp_upload['TempUpload']['filename'], array('action' => 'view', $temp_upload['TempUpload']['id']));
...
echo $this->element('Utilities.page_index', array(
	'page_title' => __('Temp Category Files'),
