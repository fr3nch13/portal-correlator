<?php 
// File: app/View/Categories/compare.ctp
...
if($category_1['CategoryType']['org_group_id'] == AuthComponent::user('org_group_id'))
{
	$details_left[] = array('name' => __('Category Group'), 'value' => $this->Html->link($category_1['CategoryType']['name'], array('admin' => false, 'controller' => 'category_types', 'action' => 'view', $category_1['CategoryType']['id'])). '&nbsp;');
}
else
{
	$details_left[] = array('name' => __('Category Group'), 'value' => $category_1['CategoryType']['name']. '&nbsp;');
}
...
if($category_2['CategoryType']['org_group_id'] == AuthComponent::user('org_group_id'))
{
	$details_right[] = array('name' => __('Category Group'), 'value' => $this->Html->link($category_2['CategoryType']['name'], array('admin' => false, 'controller' => 'category_types', 'action' => 'view', $category_2['CategoryType']['id'])). '&nbsp;');
}
else
{
	$details_right[] = array('name' => __('Category Group'), 'value' => $category_2['CategoryType']['name']. '&nbsp;');
}
