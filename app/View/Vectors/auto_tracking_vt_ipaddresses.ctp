<?php 
// File: app/View/Vectors/auto_tracking_vt_ipaddresses.ctp
...
echo $this->element('Utilities.page_index', array(
	'page_title' => __('%s Auto Tracking %s - All', __('VirusTotal'), __('IP Addresses')),
	'page_description' => __('List of %s that have been marked for automatic %s tracking.', __('IP Addresses'), __('VirusTotal')),
	'th' => $th,
	'td' => $td,
	// multiselect options
	...
	'multiselect_referer' => array(
		'admin' => false,
		'controller' => 'vectors',
		'action' => 'auto_tracking_vt_ipaddresses',
		'page' => 1,
	),
));