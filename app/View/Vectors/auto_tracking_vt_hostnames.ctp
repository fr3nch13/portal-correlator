<?php 
// File: app/View/Vectors/auto_tracking_vt_hostnames.ctp
...
echo $this->element('Utilities.page_index', array(
	'page_title' => __('%s Auto Tracking %s - All', __('VirusTotal'), __('Hostnames')),
	'page_description' => __('List of %s that have been marked for automatic %s tracking.', __('Hostnames'), __('VirusTotal')),
	'th' => $th,
	'td' => $td,
	// multiselect options
	...
	'multiselect_referer' => array(
		'admin' => false,
		'controller' => 'vectors',
		'action' => 'auto_tracking_vt_hostnames',
		'page' => 1,
	),
));