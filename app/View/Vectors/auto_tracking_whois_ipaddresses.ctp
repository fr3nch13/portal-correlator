<?php 
// File: app/View/Vectors/auto_tracking_whois_ipaddresses.ctp
...
$th = array(
	...
	'Ipaddress.whois_auto_lookup' => array('content' => __('Tracking Level'), 'options' => array('sort' => 'Ipaddress.whois_auto_lookup')),
	...
	'Ipaddress.whois_checked' => array('content' => __('Last Checked'), 'options' => array('sort' => 'Ipaddress.whois_checked')),
	'Ipaddress.whois_updated' => array('content' => __('Last Updated'), 'options' => array('sort' => 'Ipaddress.whois_updated')),
...
foreach ($vectors as $i => $vector)
{
	$td[$i] = array(
		...
		$this->Wrap->niceTime($vector['Ipaddress']['whois_checked']),
		$this->Wrap->niceTime($vector['Ipaddress']['whois_updated']),
		array(
...
echo $this->element('Utilities.page_index', array(
	'page_title' => __('WHOIS Auto Tracking Vectors - Ip Addresses'),
	'page_description' => __('List of Ip Addresses that have been marked for automatic WHOIS tracking.'),
	'th' => $th,
	'td' => $td,
	// multiselect options
	...
	'multiselect_referer' => array(
		'admin' => false,
		'controller' => 'vectors',
		'action' => 'auto_tracking_whois_ipaddresses',
		'page' => 1,
	),
));
?>