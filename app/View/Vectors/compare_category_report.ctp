...
$details_right = array();
$details_right[] = array('name' => __('Owner'), 'value' => $this->Html->link($report['User']['name'], array('controller' => 'users', 'action' => 'view', $report['User']['id'])));
$details_right[] = array('name' => __('Share State'), 'value' => $this->Wrap->publicState($report['Report']['public']));
if($report['ReportType']['org_group_id'] == AuthComponent::user('org_group_id'))
{
	$details_right[] = array('name' => __('Report Group'), 'value' => $this->Html->link($report['ReportType']['name'], array('admin' => false, 'controller' => 'report_types', 'action' => 'view', $report['ReportType']['id'])). '&nbsp;');
}
else
{
	$details_right[] = array('name' => __('Report Group'), 'value' => $report['ReportType']['name']. '&nbsp;');
}
$details_right[] = array('name' => __('Created'), 'value' => $this->Wrap->niceTime($report['Report']['created']));
$details_right[] = array('name' => __('Modified'), 'value' => $this->Wrap->niceTime($report['Report']['modified']));
...
echo $this->element('Utilities.page_compare', array(
	'page_title' => __('Compare a Category and a Report'),
	...
	'details_right_title' => __('Report'). ': '. $this->Html->link($report['Report']['name'], array('controller' => 'reports', 'action' => 'view', $report['Report']['id'])),
