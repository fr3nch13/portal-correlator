...
//	'Vector.modified' => array('content' => __('Modified'), 'options' => array('sort' => 'Vector.modified')),
	...
	'Vector.bad' => array('content' => __('Bad'), 'options' => array('sort' => 'Vector.bad')),
...
//		$this->Wrap->niceTime($vector['Vector']['modified']),
		...
		array(
			$this->Html->link($this->Wrap->yesNo($vector['Vector']['bad']), array('action' => 'toggle', 'bad', $vector['Vector']['id']),array('confirm' => 'Are you sure?')),
			array('class' => 'actions'),
		),
		array(
...
echo $this->element('Utilities.page_index', array(
	'page_title' => __('All %s', __('Vectors')),
	'th' => $th,
	'td' => $td,
	// multiselect options
