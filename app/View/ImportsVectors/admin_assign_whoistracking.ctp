<?php ?>
<!-- File: app/View/ImportsVectors/admin_assign_whoistracking.ctp -->
<div class="top">
	<h1><?php echo __('Assign WHOIS Tracking to all Vectors'); ?></h1>
</div>
<div class="center">
	<div class="posts form">
	<?php echo $this->Form->create('ImportsVector', array('url' => array('action' => 'assign_whoistracking', $import_id)));?>
	    <fieldset>
