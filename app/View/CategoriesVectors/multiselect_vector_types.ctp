<?php ?>
<!-- File: app/View/CategoriesVectors/multiselect_vector_types.ctp -->
<div class="top">
	<h1><?php echo __('Assign Vectors to Group'); ?></h1>
</div>
<div class="center">
	<div class="posts form">
	<?php echo $this->Form->create('CategoriesVector', array('url' => array('action' => 'multiselect_vector_types')));?>
	    <fieldset>
