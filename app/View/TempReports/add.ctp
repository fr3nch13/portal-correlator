...
<div class="center">
	<div class="form" id="object-form-<?php echo $form_id; ?>">
		    ...
		    <fieldset>
		    	...
		    	<?php
					...
					echo $this->Form->input('scan_desc', array(
						'type' => 'checkbox',
						'checked' => true,
						'label' => __('Check to scan Description for %s', __('Vectors')),
					));
		...
		<?php echo $this->Form->end(__('Save %s', __('Report'))); ?>
	</div>
</div>
