...
?>
<div class="top">
	<h1><?php echo __('Edit %s', __('Temp Report')); ?></h1>
</div>
<div class="center">
	<div class="form" id="object-form-<?php echo $form_id; ?>">
		<?php echo $this->Form->create('TempReport');?>
		    <fieldset>
		        <legend><?php echo __('Edit %s', __('Temp Report')); ?></legend>
		    	<?php
					...
					echo $this->Form->input('scan_desc', array(
						'type' => 'checkbox',
						'label' => 'Check to rescan Description for Vectors',
					));
					echo $this->Form->input('TempReportsDetail.id', array(
						'type' => 'hidden'
					));
					echo $this->Form->input('TempReportsDetail.desc', array(
						'label' => __('Description'),
					));
					echo $this->Form->input('TempReportsDetail.desc_private', array(
		...
		<?php echo $this->Form->end(__('Save %s', __('Temp Report'))); ?>
	</div>
</div>
